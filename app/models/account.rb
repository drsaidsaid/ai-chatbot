...
class Account < ApplicationRecord # rubocop:disable Metrics/ClassLength
  ...
  has_one :ai_provider_connection, class_name: 'AiLeadEmployee::AiProviderConnection', dependent: :destroy_async
  has_one :google_calendar_connection, class_name: 'AiLeadEmployee::GoogleCalendarConnection', dependent: :destroy_async
