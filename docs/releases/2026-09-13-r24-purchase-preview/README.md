...
The coordinator explicitly withheld the build and in-app browser lane during
this interval. Production build and loopback-only desktop/phone browser acceptance
remain pending coordinator allocation. Browser acceptance must not submit payment
instructions or call any external provider.
