...
REL=pathlib.Path('docs/releases/2026-09-11-r09-delivery-increment1')
REF='refs/r09/delivery-increment1-verified-source-20260911'
ENV=os.environ.copy();ENV['GIT_INDEX_FILE']=str(ROOT/'tmp/r09/delivery-increment1-verified-source.index')
...
if sys.argv[1]=='freeze':
 ...
 (ROOT/'tmp/r09/delivery-increment1-verified-source-identity.json').write_text(json.dumps(report,indent=2)+'\n');print(json.dumps(report))
