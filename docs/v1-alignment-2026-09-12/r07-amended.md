...
- [ ] Preserve current explicit Offer context and clear qualification-disabled/not-configured presentation. Human assistance and sales-call eligibility are distinct; a lead refusing the bot is not trapped in questions.
- [ ] Keep reviewed takeover/pause/resume and stale account/Conversation guards. This ticket does not implement billing or broaden automated send authority.
