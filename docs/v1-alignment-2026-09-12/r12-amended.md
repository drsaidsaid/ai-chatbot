...
- [ ] Resolve relevant knowledge gaps and human-help work without forcing sales qualification. An operator response can propose reusable knowledge but requires explicit approval before publication.
- [ ] Capture poor-fit/not-ready handoff feedback as reviewable evidence/configuration suggestions; never silently change rules. Keep private notes out of answers.
