...
- [ ] Use selected Offer eligibility and Lead agreement rather than a global Highly Qualified-only rule; distinguish free sales-call and other permitted appointment paths.
- [ ] Paid consultation is an optional business Offer implemented in R28; provide an extensible prerequisite gate but do not build duplicate payment logic here. Preserve conflict-free Google Calendar availability, timezone, cancellation and idempotency.
