...
- [ ] Separate qualified sales-call work from basic human-help/unknown-question Review Requests. Prioritise sales using published fit/readiness criteria; asking for help does not promise access to the owner.
- [ ] Show relevant business facts, goal, obstacle, readiness, evidence and consent in the team summary; do not require the original lead-volume interview for every business.
